...
class GS_Connector_Adds
{
    ...
    public function show_gs_adds()
    {
        ...
        $review_text .= 'Upgrade to <a href="https://thedigitz.com/" target"_blank" >CF7 GSheetConnector PRO</a> with automated sheets to setup within few clicks. Grab the deal with discounted price.';
