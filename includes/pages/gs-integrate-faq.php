...
<div class="tab-full">
    ...
    <div class="content">
        ...
        <p><?php echo esc_html(__('And then try to activate the plugin again. This will create a debug.log under wp-content folder.&nbsp;Check for cf7 google sheet connector error.')); ?></p>
