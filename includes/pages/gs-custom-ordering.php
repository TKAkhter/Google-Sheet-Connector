<div class="cd-faq-items">
   <ul id="basics" class="cd-faq-group">
      <li class="content-visible">
         <a class="cd-faq-trigger" href="#0"><?php echo esc_html(__('Custom Ordering - ', 'gsconnector')); ?></a>
      ...
      <table class="gs-field-list">
                            ...
                            foreach ($assoc_arr as $key => $value) {
                                foreach ($value as $k => $v) {
                                    ...
                                    ?>
               <tr>
                  <td><input type="checkbox" checked="checked"  name="gs-custom-ck[<?php echo $count; ?>]" value="1" <?php echo $checked; ?> ></td>
                  <td><?php echo $v; ?> : </td>
                  <td>
