<?php
/*
  Plugin Name: Google Sheet Integration with Contact Form 7
  Plugin URI:
  Description: Integrate your Contact Form 7 forms to Google Sheets spreadsheet.
  Version: 1.0
  Author: Talha Akhter
  Author URI: https://thedigitz.com/
  Text Domain: thedigitz
 */
...
define('GS_CONNECTOR_VERSION', '1');
define('GS_CONNECTOR_DB_VERSION', '1');
...
// remove-- load_plugin_textdomain('gsconnector', false, basename(dirname(__FILE__)) . '/languages');
...
class Gs_Connector_Free_Init
{
 ...
 <input type="text" name="gs-code" id="gs-code" value="" disabled placeholder="<?php echo esc_html(__('Currently Active', 'gsconnector')); ?>"/>
               ...
               <input type="text" name="gs-code" id="gs-code" value="" placeholder="<?php echo esc_html(__('Enter Code', 'gsconnector')); ?>"/>
                    <a href="https://accounts.google.com/o/oauth2/auth?access_type=offline&approval_prompt=force&client_id=702466234149-sjfnt79f7c4gp1bgfk5vikk40fck0p4g.apps.googleusercontent.com&redirect_uri=urn:ietf:wg:oauth:2.0:oob&response_type=code&scope=https%3A%2F%2Fspreadsheets.google.com%2Ffeeds%2F+https://www.googleapis.com/auth/userinfo.email+https://www.googleapis.com/auth/drive.metadata.readonly" target="_blank" class="button">Get Code</a>
                     <?php } ?>
                  </p>
